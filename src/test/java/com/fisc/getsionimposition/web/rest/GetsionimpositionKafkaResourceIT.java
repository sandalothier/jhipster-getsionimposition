package com.fisc.getsionimposition.web.rest;

import com.fisc.getsionimposition.GetsionimpositionApp;
...
@SpringBootTest(classes = GetsionimpositionApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class GetsionimpositionKafkaResourceIT {
    ...
    @Autowired
    private GetsionimpositionKafkaProducer producer;

    @Autowired
    private GetsionimpositionKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        GetsionimpositionKafkaResource kafkaResource = new GetsionimpositionKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/getsionimposition-kafka/publish?message=test"))
