package com.fisc.getsionimposition.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("getsionimposition");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("getsionimposition");
        ...
        config.getMapConfigs().put("com.fisc.getsionimposition.domain.*", initializeDomainMapConfig(jHipsterProperties));
